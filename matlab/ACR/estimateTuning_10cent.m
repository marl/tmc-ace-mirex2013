function [shiftFB,centerA4,tuningSemitones,sideinfo] = estimateTuning_10cent(f_input,parameter,sideinfo)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name: estimateTuning
...
tunings = [-.45 -0.4:0.1:0.4 0.45];
numTunings = length(tunings);
